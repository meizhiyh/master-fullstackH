...
Route::get('/posts/category/{id}', 'PostController@getPostsByCategory')->name('posts.getByCategory');
Route::get('/posts/user/{id}', 'PostController@getPostsByUser')->name('posts.getByUser');